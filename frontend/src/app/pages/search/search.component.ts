...
import {BehaviorSubject, map, Observable, of, switchMap, withLatestFrom, combineLatest, Subscription} from "rxjs";
...
export class SearchComponent implements OnDestroy {
  ...
  public readonly searchResult$: Observable<MovieDetailDTO[]> = this.query$.pipe(
    withLatestFrom(this.page$),
    switchMap(([searchQuery, page]) => this.moviesService.search(searchQuery, page)),
  );
