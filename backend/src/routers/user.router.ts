...
router.delete("/watched/:movieId", authenticateJWT, deleteWatchedMovie); // Remove movie from watched list
...
router.delete("/watchLater/:movieId", authenticateJWT, deleteWatchLaterMovie); // Remove movie from watch later list
